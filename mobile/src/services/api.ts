 ...
 * 适配 React Native，使用 AsyncStorage 和 process.env.EXPO_PUBLIC_xxx
 */
import axios from 'axios';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { DeviceEventEmitter } from 'react-native';

const API_BASE = process.env.EXPO_PUBLIC_API_BASE_URL || 'http://localhost:8000/api';
