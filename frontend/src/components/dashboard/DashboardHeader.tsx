  ...
  if (isMobile) {
    return (
      <div className="top-status-bar" style={{ padding: 'clamp(12px, 2vw, 16px) clamp(16px, 3vw, 24px)', background: 'linear-gradient(180deg, #141b26 0%, #0f151e 100%)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <div className="dashboard-header-mobile" style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          <div className="dashboard-header-mobile-top dashboard-header-mobile-top-row" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8, flexWrap: 'wrap' }}>
            <div className="dashboard-header-mobile-boot">
          ...
          <div className="dashboard-header-mobile-status dashboard-header-mobile-status-row" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8, flexWrap: 'wrap' }}>
            <div className="dashboard-header-mobile-status-shell">
              {systemStatus}
            </div>
            <div className="dashboard-header-mobile-balance-shell">
              {balanceBadge}
            </div>
          </div>
