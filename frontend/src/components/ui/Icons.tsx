...
export const ReloadIcon: React.FC<IconProps> = ({ className, style }) => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className={className} style={style}>
...
export const UnlockIcon: React.FC<IconProps> = ({ className, style }) => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className={className} style={style}>
...
export const ChartIcon: React.FC<IconProps> = ({ className, style }) => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className={className} style={style}>
...
export const BulbIcon: React.FC<IconProps> = ({ className, style }) => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className={className} style={style}>
