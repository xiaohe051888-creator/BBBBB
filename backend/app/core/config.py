...
class Settings:
    ...
    SINGLE_AI_REQUEST_TIMEOUT_SECONDS: int = int(os.getenv("SINGLE_AI_REQUEST_TIMEOUT_SECONDS", "75"))
    SINGLE_AI_MAX_RETRIES: int = int(os.getenv("SINGLE_AI_MAX_RETRIES", "2"))
    SINGLE_AI_TOTAL_TIMEOUT_SECONDS: int = int(os.getenv("SINGLE_AI_TOTAL_TIMEOUT_SECONDS", "120"))
    ...
    WATCHDOG_P1_ERROR_THRESHOLD: int = int(os.getenv("WATCHDOG_P1_ERROR_THRESHOLD", "5"))
