...
class SystemState(Base):
    ...
    analysis_cycle_status = Column(String(20), nullable=True, comment="单AI分析轮次状态")
    analysis_cycle_stage = Column(String(20), nullable=True, comment="单AI分析轮次阶段")
    analysis_cycle_attempt = Column(Integer, nullable=True, comment="单AI分析轮次序号")
    analysis_cycle_started_at = Column(DateTime, nullable=True, comment="单AI分析开始时间")
    analysis_cycle_deadline_at = Column(DateTime, nullable=True, comment="单AI分析截止时间")
    analysis_failure_code = Column(String(64), nullable=True, comment="单AI分析失败编码")
    analysis_failure_message = Column(Text, nullable=True, comment="单AI分析失败说明")
    analysis_retryable = Column(Boolean, default=False, nullable=False, comment="单AI分析是否可重试")
