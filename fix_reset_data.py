...
content = content.replace("from app.models.schemas import GameRecord, BetRecord, SystemLog", "from app.models.schemas import GameRecord, BetRecord, SystemLog, MistakeBook")
